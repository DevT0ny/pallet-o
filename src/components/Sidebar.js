...
export default class SlideBar extends Component {
    ...
    render() {
        ...
        return (
          <nav className="w-48 slidebar hidden lg:block h-screen fixed shadow-md top-0 left-0">
